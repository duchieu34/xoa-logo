...
def main() -> int:
    ...
    report: dict[str, Any] = {
        ...
        "mask": {
            ...
            "coverage_ratio": mask_result.coverage_ratio,
            "span_ratio": list(mask_result.span_ratio),
            "rectangularity": mask_result.rectangularity,
            "alignment_scale": mask_result.alignment_scale,
            "alignment_offset": mask_result.alignment_offset,
            "requested_dilation": mask_result.requested_dilation,
            "effective_dilation": mask_result.effective_dilation,
            "final_coverage_ratio": mask_result.final_coverage_ratio,
        },
